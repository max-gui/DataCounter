...
var nonWorkingWeekdays = {
    ...
    2016 : [[1, 1], [2, 8], [2, 9], [2, 10], [2, 11], [2, 12], [4, 4], [5, 2], [6, 9], [6, 10],[9,15],[9,16]]
};
var workingWeekEnds = {
    2014 : [[9, 28], [10, 11]],
    2015 : [[1, 4], [2, 15], [2, 28], [9, 6], [10, 10]],
    2016 : [[2, 6], [2, 14], [6, 12], [9,18]]
};
...
function processTable(table) {
	...
	table.children('tbody').children('tr').each(function(i, row) {
        ...
        if (!isWorkingDay)
        {
          $(listBodies[1]).children('td:first-child').css('background-color', '#009ad6');
        }
